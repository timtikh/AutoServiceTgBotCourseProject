...
def get_profile_template(user):
    return f"{line_separator}\n👤 Имя пользователя: {user.get_name()}\n📝 id: {user.get_id()}\n📞 Телефон: {user.get_phone()}\n🚗 VIN: {user.get_vin()}\n🏷 Марка: {user.get_brand()}\n🚘 Модель: {user.get_model()}\n📅 Год выпуска: {user.get_year()}\n📈 Кол-во заказов: {len(user.get_orders())}\n📅 Дата регистрации: {user.get_register_date_string()}\n{line_separator}"

def get_faq_template(shop_name):
    return f"{line_separator}\nℹ️ FAQ по записи в автосервис {shop_name}\n{line_separator}"
...
faq = "ℹ️ FAQ"
profile = "📁 Профиль"
catalogue = "🗄️ Список доступных услуг"
cart = "🛒 Планируемые услуги"
support_menu = "☎ Меню тех. поддержки"

# Admin panel tabs
item_management = "📦 Управление услугами"
user_management = "🧍 Управление пользователями"
shop_stats = "📈 Статистика автосервиса (BETA)"
bot_settings = "⚙ Настройки бота"

# FAQ
contacts = "📞 Контакты"
refund = "🎫 Публичная оферта"

# Profile
my_orders = "📂 Мои посещения в сервис"
cancel_order = "❌ Отменить запись в сервис"
restore_order = "✅ Восстановить запись в сервис"
...
# Catalogue / Item / Cart
search = "🔍 Найти"
add_to_cart = "🛒 Добавить в список услуг"
cart_is_empty = "Ваш список услуг пуст."
pickup = "✅Самовывоз"
def delivery_on(price): return f"✅ Доставка - {price}руб."
def delivery_off(price): return f"❌ Доставка - {price}руб."
cart_checkout = "Оформить заказ"
clear_cart = "Очистить список моих услуг"
...
add_item = "🗃️ Добавить услугу"
edit_cat = "✏️ Редактировать категорию"
edit_item = "✏️ Редактировать услугу"
...
item_settings = "🗃️ Настройки услуг"
